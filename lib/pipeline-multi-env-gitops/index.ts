...
export default class PipelineMultiEnvGitops {
    ...
    async buildAsync(scope: Construct, id: string, pipelineProps: PipelineMultiEnvGitopsProps, props?: StackProps) {
        ...
        const devArgoAddonConfig = createArgoAddonConfig('dev', 'git@github.com:sunilcsi/eks-blueprints-workloads.git');
        const testArgoAddonConfig = createArgoAddonConfig('test', 'git@github.com:sunilcsi/eks-blueprints-workloads.git');
        const prodArgoAddonConfig = createArgoAddonConfig('prod', 'git@github.com:sunilcsi/eks-blueprints-workloads.git');
        ...
        argoAdditionalProject.push(
            {
                ...
                sourceRepos: [
                    ...
                    `git@github.com:sunilcsi/eks-blueprints-workloads.git`,
                ],
            }
        );
    });
